...
-- điều chỉnh khi xoá sửa các dữ liệu liên quan đến khoá ngoại
BEGIN TRANSACTION
...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.DOANHSO_DAILY
	DROP CONSTRAINT FK_DOANHSO_DAILY_DAILY
GO
ALTER TABLE dbo.CONGNO_DAILY
	DROP CONSTRAINT FK_CONGNO_DAILY_DAILY
GO
ALTER TABLE dbo.PHIEUXUATHANG
	DROP CONSTRAINT FK_PHIEUXUATHANG_DAILY
GO
ALTER TABLE dbo.PHIEUTHUTIEN
	DROP CONSTRAINT FK_PHIEUTHUTIEN_DAILY
GO
ALTER TABLE dbo.DAILY SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.PHIEUTHUTIEN ADD CONSTRAINT
	FK_PHIEUTHUTIEN_DAILY FOREIGN KEY
	(
	MaDaiLy
	) REFERENCES dbo.DAILY
	(
	MaDaiLy
	) ON UPDATE  CASCADE 
	 ON DELETE  CASCADE 
...
GO
ALTER TABLE dbo.PHIEUTHUTIEN SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.PHIEUXUATHANG ADD CONSTRAINT
	FK_PHIEUXUATHANG_DAILY FOREIGN KEY
	(
	MaDaiLy
	) REFERENCES dbo.DAILY
	(
...
GO
ALTER TABLE dbo.PHIEUXUATHANG SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.DOANHSO_DAILY ADD CONSTRAINT
	FK_DOANHSO_DAILY_DAILY FOREIGN KEY
	(
	MaDaiLy
	) REFERENCES dbo.DAILY
	(
...
GO
ALTER TABLE dbo.DOANHSO_DAILY SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.CONGNO_DAILY ADD CONSTRAINT
	FK_CONGNO_DAILY_DAILY FOREIGN KEY
	(
	MaDaiLy
	) REFERENCES dbo.DAILY
	(
...
GO
ALTER TABLE dbo.CONGNO_DAILY SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
...
ALTER TABLE dbo.DAILY
	DROP CONSTRAINT FK_DAILY_QUAN
GO
ALTER TABLE dbo.QUAN SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.PHIEUXUAT_MATHANG
	DROP CONSTRAINT FK_PHIEUXUATMATHANG_PHIEUXUATHANG
GO
ALTER TABLE dbo.PHIEUXUATHANG SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
...
GO
ALTER TABLE dbo.PHIEUXUAT_MATHANG
	DROP CONSTRAINT FK_PHIEUXUATMATHANG_MATHANG
GO
ALTER TABLE dbo.MATHANG SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.DAILY
	DROP CONSTRAINT FK_DAILY_LOAIDAILY
GO
ALTER TABLE dbo.LOAIDAILY SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.PHIEUXUAT_MATHANG
	DROP CONSTRAINT FK_PHIEUXUATMATHANG_DONVITINH
GO
ALTER TABLE dbo.DONVITINH SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.PHIEUXUAT_MATHANG ADD CONSTRAINT
	FK_PHIEUXUATMATHANG_MATHANG FOREIGN KEY
	(
	MaMatHang
	) REFERENCES dbo.MATHANG
	(
	MaMatHang
	) ON UPDATE  CASCADE 
	 ON DELETE  CASCADE 
...
GO
ALTER TABLE dbo.PHIEUXUAT_MATHANG ADD CONSTRAINT
	FK_PHIEUXUATMATHANG_DONVITINH FOREIGN KEY
	(
	MaDonViTinh
...
GO
ALTER TABLE dbo.PHIEUXUAT_MATHANG ADD CONSTRAINT
	FK_PHIEUXUATMATHANG_PHIEUXUATHANG FOREIGN KEY
	(
	MaPhieuXuat
	) REFERENCES dbo.PHIEUXUATHANG
	(
	MaPhieuXuat
	) ON UPDATE  CASCADE 
	 ON DELETE  CASCADE 
...
GO
ALTER TABLE dbo.PHIEUXUAT_MATHANG SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.DAILY ADD CONSTRAINT
	FK_DAILY_LOAIDAILY FOREIGN KEY
	(
	MaLoaiDaiLy
	) REFERENCES dbo.LOAIDAILY
	(
	MaLoaiDaiLy
	) ON UPDATE  CASCADE 
	 ON DELETE  CASCADE 
...
GO
ALTER TABLE dbo.DOANHSO_DAILY
	DROP CONSTRAINT FK_DOANHSO_DAILY_DOANHSO
GO
ALTER TABLE dbo.BAOCAODOANHSO SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.DOANHSO_DAILY ADD CONSTRAINT
	FK_DOANHSO_DAILY_DOANHSO FOREIGN KEY
	(
	MaBaoCaoDoanhSo
	) REFERENCES dbo.BAOCAODOANHSO
	(
	MaBaoCaoDoanhSo
	) ON UPDATE  CASCADE 
	 ON DELETE  CASCADE 
...
GO
ALTER TABLE dbo.CONGNO_DAILY
	DROP CONSTRAINT FK_CONGNO_DAILY_CONGNO
GO
ALTER TABLE dbo.BAOCAOCONGNO SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
BEGIN TRANSACTION
GO
ALTER TABLE dbo.CONGNO_DAILY ADD CONSTRAINT
	FK_CONGNO_DAILY_CONGNO FOREIGN KEY
	(
	MaBaoCaoCongNo
	) REFERENCES dbo.BAOCAOCONGNO
	(
	MaBaoCaoCongNo
	) ON UPDATE  CASCADE 
	 ON DELETE  CASCADE 
